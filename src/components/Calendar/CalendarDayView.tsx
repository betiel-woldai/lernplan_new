...
export default function CalendarDayView({
  ...
  useEffect(() => {
    const handleSessionUpdate = (event: any) => {
      console.log('📅 CalendarDayView: Session updated', event.detail);
              ...
              .map((session) => {
                ...
                <div
                  ...
                  style={{
                    ...
                    borderLeftStyle: autoGenerated ? 'dashed' : 'solid',
                    boxShadow: autoGenerated ? 'inset 0 0 0 1px rgba(37,99,235,0.15)' : undefined,
                  }}
                  onClick={(e) => {
                    // For fixed/all-day entries open details if available, otherwise do nothing
                    if ((session as any).isFixed || session.isAllDay || session.subjectName === 'Termine & Fristen') {
                      e.preventDefault();
                      e.stopPropagation();
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        ...
                        <div className="flex-shrink-0">
                          {((session as any).isFixed || session.isAllDay) ? (
